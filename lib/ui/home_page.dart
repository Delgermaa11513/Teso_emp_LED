...
import 'package:flutter_application_2/components/weather_item.dart';
import 'package:flutter_application_2/constants.dart';
import 'package:flutter_application_2/ui/detail_page.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  static String API_KEY = "VN7BE2ZK6XEAE2H7LHD5TWPJJ";
                      ...
                      TextButton(
                        onPressed: () => showDialog<String>(
                          ...
                          builder: (BuildContext context) => AlertDialog(
                            ...
                            content: Text('$dailyWeatherForecast'),
                            actions: <Widget>[
                              TextButton(
                                onPressed: () =>
